...
class ViewAttentionModule(nn.Module):
    def __init__(self, supply=False):
        ...
        self.rd_single_conv_block2_1x1 = ConvBlock(in_ch=64, out_ch=4, k_size=3, pad=1, dil=1)
        self.ra_single_conv_block2_1x1 = ConvBlock(in_ch=64, out_ch=4, k_size=3, pad=1, dil=1)
        # 训练使用，评估不使用
